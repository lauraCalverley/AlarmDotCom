...
class Adc
{
    ...
    public function csg()
    {
        $this->authentication = $this->config['CSGAuthentication'];
        return $this;
    }
    ...
    {
        return (array)$this->dealerClient()->GetPanelVersionMappings()->GetPanelVersionMappingsResult;
    }
